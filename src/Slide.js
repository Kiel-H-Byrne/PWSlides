      ...
      <div
        ...
        <Grid
          ...
          <Grid item xs={12}>
            ...
            <Grid item>
              <Typography className="slide-title" align="center">
                Shout Out
              </Typography>
            </Grid>
          </Grid>
          ...
          <Grid item xs={12}>
            <Typography className="slide-person" align="right">
              - {values[4]}
            </Typography>
          </Grid>
          <Grid item xs={12}>
            <Typography className="slide-date" align="center">
              {format(new Date(values[0]), "MMMM Do, YYYY")}
            </Typography>
          </Grid>
        </Grid>
      </div>
